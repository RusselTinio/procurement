...
$id=$_GET['id'];
$sql=$conn->query("SELECT * FROM supplies ");
$sql_sup=$conn->query("SELECT * FROM supplies WHERE item_num=$id");
            ...
            <form action="../backend/add_supplies.php" method="POST">
                ...
                <div class="box-container">
                 ...
                 <div class="row">
                    ...
                    <div class="col-75">
                    <input type="text" name="item-name" id="item-item" value="<?php echo $row1['item_name'] ?>">
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
