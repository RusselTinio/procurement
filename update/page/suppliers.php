        ...
        <div class="content">
            ...
            <form action="../backend/add_supplier.php" method="POST">
                ...
                <div class="wrapper"> 
                    <div class="row">
                        <div class="col-25">
                        <label for="supplier-name" id="item" >Supplier Name</label>
                        </div>
                        <div class="col-75">
                            <input type="text" name="supplier-name" id="item-item">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-25">
                        ...
                        <div class="col-75">
                            <input type="text" name="address" id="item-item">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-25">
                        ...
                        <div class="col-75">
                            <input type="text" name="contact_num" id="item-item">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <?php
                        while($row= $sql->fetch(PDO::FETCH_ASSOC)){
                            echo "<tr>
                                    ...
                                    <td><a href='edit_supplier.php?id=".$row['supplier_num']."'>Edit</a> <a href='../backend/delete_supplier.php?id=".$row['supplier_num']."'>Delete</a></td>
                            </tr>";
                        }
                        ?>
                    </tbody>
